...
import com.mylog.appointment.controller.AppointmentController;
import com.mylog.appointment.cucumber.SharedState;
...
public class AppointmentSteps {
    ...
    private Optional<Appointment> response;
    ...
    public void the_user_requests_the_appointment() {
        response = appointmentService.getAppointmentById(sharedState.getAppointmentId());
    }
    ...
    public void the_appointment_should_no_longer_exist() {
        Optional<Appointment> appointment= appointmentService.getAppointmentById(sharedState.getAppointmentId());
        Assertions.assertTrue(appointment.isEmpty());
    }
}
