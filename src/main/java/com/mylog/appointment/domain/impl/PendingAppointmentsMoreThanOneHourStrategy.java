...
@Service
public class PendingAppointmentsMoreThanOneHourStrategy implements VisitorMetricsStrategy {
    ...
    public long calculate(LocalDateTime startDate, LocalDateTime endDate) {
        ...
        return appointmentRepository.findByStatusAndAppointmentDateBetween("PENDING", oneHourAgo, endDate).size();
    }
}
